...
<section>
	<div class="p-6 flex flex-col items-center justify-start space-y-6">
		...
		<a
			...
			class="w-full overflow-clip aspect-square md:aspect-video rounded-xl transition hover:border-[0.8px] border-outline duration-200 bg-white flex flex-col justify-between"
		>
